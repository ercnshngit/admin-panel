    ...
    >
      ...
      >
        <div className="z-50 p-2" id={component.code}>
          <div className="p-2">
            {component.component.name} - {component.component.tag.name}
          </div>
          {renderComponent()}
        </div>
        {dragDrop && draggingActive && (
          <>
            <div
              ref={topHalf.setNodeRef}
              className={cn(
                "absolute w-full top-0 rounded-t-md ",
                selectedElement ? "h-2" : "h-1/4"
              )}
            />
            ...
            <div
              ...
              className={cn(
                "absolute bottom-0 w-full h-1/4 rounded-b-md ",
                selectedElement ? "h-2" : "h-1/4"
              )}
            />
          </>
        ...
        {dragDrop &&
          ...
          component.children?.length === 0 && (
            <div
              ...
              className={cn("absolute w-full px-2 h-1/3 bottom-1/3 ")}
            >
