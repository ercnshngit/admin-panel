...
export default function Designer({ dragDrop }: { dragDrop: boolean }) {
  ...
  useEffect(() => {
    if (selectedElement?.component.name && typeof window !== "undefined") {
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "bg-background min-h-[400px] h-full m-auto  flex flex-col flex-grow items-center justify-start flex-1",
