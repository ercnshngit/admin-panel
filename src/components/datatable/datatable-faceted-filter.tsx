                ...
                {selectedValues.size > 2 ? (
                  ...
                  options
                    ...
                    .map((option) => {
                      ...
                      const displayColumnName = table?.column_relations?.find(
                        (item) => item.column.name === filterable.name
                      )?.referenced_table?.display_column?.name;

                      const label = displayColumnName
                        ? labelData?.[displayColumnName]
                        : labelData?.name ||
                          labelData?.title ||
                          labelData?.key ||
                          labelData?.code ||
