    ...
    <div className="flex flex-col gap-4 mb-12">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 ">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>{translate("CONFIG_GROUP_TITLE")}</FormLabel>
                <FormControl>
                  <Input {...field} />
                </FormControl>
                <FormDescription>
                  {translate("CONFIG_GROUP_DESCRIPTION")}
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            name="is_hidden"
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between p-3 bg-white border rounded-lg shadow-sm">
            ...
            {fields.map((column, index) => {
              ...
              return (
                <AccordionItem className="" value={column.id} key={column.id}>
                  <div className="px-4 bg-gray-100 rounded ">
                    ...
                    <AccordionContent>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-col gap-4 p-3 bg-white border rounded-lg shadow-sm">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-center justify-between gap-4 p-3 bg-white border rounded-lg shadow-sm">
                              <div className="space-y-0.5">
                                <FormLabel>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex flex-row items-center justify-between col-span-2 gap-4 p-3 bg-white border rounded-lg shadow-sm">
                              <div className="space-y-0.5">
                                <FormLabel>
      ...
      <div className="flex flex-col p-4 bg-gray-100 rounded-md">
        ...
        {table.column_relations?.map((relation, index) => {
          return (
            <div key={index} className="flex gap-4 p-4 bg-white rounded-md">
...
function Options({ index, form }: { index: number; form: any }) {
  ...
  return (
    <div>
      <div className="flex flex-col gap-4 ml-3 border-l-2 border-red-500">
        ...
        {fields.map((item, k) => {
          return (
            <div key={item.id} className="flex h-10 gap-2 ml-3">
              <input
      ...
      <Button
        className="flex items-center mt-2 bg-green-500 hover:bg-green-600"
        variant={"default"}
        type="button"
        onClick={() =>
          append({
